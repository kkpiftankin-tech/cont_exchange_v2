...
### FR-ORDER-004. Exchange-provider (F2-17, v2/IN-004)
...
Acceptance: F-02 ([UC-F02-01 A3](use-cases/UC-F02-01-create-flow-order/use-case.md)); источник IN-004 §3.1 F2-17.
