...
| Уровень | Где |
| --- | --- |
| ⬆️ Parent feature L0 ☁️ | [F-09-batch-combo-orders](../../features/F-09-batch-combo-orders/) |
| ☁️ L0 system sequence | [SEQ-UC-F09-01-system](sequences/SEQ-UC-F09-01-system.md) — system как чёрный ящик |
| 🌊 L1 service sequence | [SEQ-F09-UC-F09-01-services](../../../05-components/sequences/SEQ-F09-UC-F09-01-services.md) — взаимодействие сервисов |
