...
| ☁️ L0 system sequence | [SEQ-UC-F11-02-system](sequences/SEQ-UC-F11-02-system.md) — system как чёрный ящик |
| 🌊 L1 service sequence | [SEQ-F11-02-publish-snapshot-services](../../../05-components/sequences/SEQ-F11-02-publish-snapshot-services.md) — взаимодействие сервисов |
