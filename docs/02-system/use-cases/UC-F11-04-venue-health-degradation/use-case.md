...
| ☁️ L0 system sequence | [SEQ-UC-F11-04-system](sequences/SEQ-UC-F11-04-system.md) — system как чёрный ящик |
| 🌊 L1 service sequence | [SEQ-F11-04-health-routing-services](../../../05-components/sequences/SEQ-F11-04-health-routing-services.md) — взаимодействие сервисов |
