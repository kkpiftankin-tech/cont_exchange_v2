...
|---|---|---|---|
| 1 | **inventory-skew на полное обязательство**: matching читает `position` (=c, под A7 у band); должен брать `c + in_flight` (истинный инвентарь), иначе skew ослаб при большом in_flight | Высокий | §A2 + A7-взаимодействие |
