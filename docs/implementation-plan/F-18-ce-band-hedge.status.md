...
| 3 | **Развести комиссию полки vs порога**: §A1 кладёт комиссию в полку кривой, §6.4 — в пороги. 🔎 **Зафиксировано в ADR-065 (Q1)** — конфликт доков, требует решения владельца (текущий выбор: комиссия в обоих местах, тюнинг k_band компенсирует) | Средний | ADR-065, §A1 vs §6.4 |
| 4 | **Порог арбитражёра: перевоз vs рыночный хедж**: по §A8.1 арбитражёр перевозит (тариф+ETA, дренаж по приходу), у нас — рыночная заявка (бирж. taker). 🔎 **Зафиксировано в ADR-065 (Q2)** — упирается в нереализованную подсистему перевозов | Средний | ADR-065, §A7/§A8.1 |
