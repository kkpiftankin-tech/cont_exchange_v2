...
| [F-20](../02-system/features/F-20-live-venue-simulator/) | ✅ UC-F20-01/02 | ✅ 2 L0 | ✅ 2 L1 | ✅ sim-topics + admin REST (proto TODO, CN-F20-02) | ✅ sim-sessions/sim-execution-reports docs (DDL в infra — impl) | ⚠️ базовый sim в `cpp/venues/venues_loop.cpp` есть; router/models/sessions/shadow planned | ✅ test plan (unit/IT/ledger/load/SLA) | planned (docs ✅) — **IN-010 ingested (docs-only)**; расширение существующего наивного симулятора; блокеры: ADR топики/proto (CN-F20-02/04) + sim-book Ledger (CN-F20-03) |
