...
| [F-09](../02-system/features/F-09-batch-combo-orders/) | ✅ UC-F09-01/02/03 | ✅ | ✅ | ✅ combo grpc + execution.groups (⚠️ 5 TODO, proto sketch) | ✅ combo_*/execution_groups + grouped_* CH (⚠️ DDL→devops) | ✅ | ✅ test plan + unit/integration suites green (incl. constraint_evaluator, trigger_condition, child_graph repo live PG) | MVP-1/2/3/4/4.1 LIVE (PR #13): grouped solver→ledger, constraints, OCO/bracket+conditional runtime, honest-mode, risk.alerts, observability (ADR-031..035). Остаток: atomic OCO, QP (deferred), external legs, frontend |
