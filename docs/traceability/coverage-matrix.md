...
| [F-05A](../02-system/features/F-05-live-market-data/addendum-F05A-vectorized-external-liquidity.md) | ✅ UC-F05A-01..05 | ✅ 5 L0 | ✅ 5 L1 | ✅ vector_liquidity.proto (compiles) + marketdata.vectorized + gRPC/REST docs | ✅ PG asset_basis/vector_flow_segments/vectorization_runs + CH vector_clearing_results/surplus_events/vector_flow_segments_history (DDL) | ⏳ market_data/matching/ledger (код planned) | ✅ test plan (unit/integration-real-fixtures/UI/replay/perf) | planned (docs ✅) — **IN-014 ingested** (feature/UC/sequences/contracts/data/FR/NFR/entities/business-rules §F-05A/tasks/test-plan); ADR-047 (surplus) + ADR-048 (OSQP QP) `proposed`; код после ADR→accepted |
...
| [F-18](../02-system/features/F-18-ce-capital-position-hedge/) | ✅ UC-F18-04 (v2; UC-F18-01..03 superseded) | ✅ | ✅ | ✅ doc (planned proto: `ce.position.delta` / `execution.intents` / GetAgentPositions / PreHedgeCheck, ADR-061) | ✅ planned DDL (ce_agent_position / f05a_clearing_config +cols / ce_transfer / clearing_trace) | ⏸ matching/risk/ledger/venues/market-data (code gated ADR-061) | ✅ test plan (unit/integration/contract, feature.yaml) | docs ✅ — ADR-061/062/063 `accepted` (2026-09-15); код planned (не написан), эмиссия — после security-CRITICAL |
