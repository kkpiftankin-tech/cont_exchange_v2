...
type GetMetricsHandlerFunc func(GetMetricsParams, *models.User) middleware.Responder

// Handle executing the request and returning a response
func (fn GetMetricsHandlerFunc) Handle(params GetMetricsParams, principal *models.User) middleware.Responder {
	return fn(params, principal)
}

// GetMetricsHandler interface for that can handle valid get metrics params
type GetMetricsHandler interface {
	Handle(GetMetricsParams, *models.User) middleware.Responder
}
