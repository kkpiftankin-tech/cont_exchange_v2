...
func NewPostTransactionsDepositParams() PostTransactionsDepositParams {

	return PostTransactionsDepositParams{}
}
...
//
// To ensure default values, the struct must have been initialized with NewPostTransactionsDepositParams() beforehand.
func (o *PostTransactionsDepositParams) BindRequest(r *http.Request, route *middleware.MatchedRoute) error {
	var res []error
