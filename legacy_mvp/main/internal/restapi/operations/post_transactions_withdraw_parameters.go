...
func NewPostTransactionsWithdrawParams() PostTransactionsWithdrawParams {

	return PostTransactionsWithdrawParams{}
}
...
//
// To ensure default values, the struct must have been initialized with NewPostTransactionsWithdrawParams() beforehand.
func (o *PostTransactionsWithdrawParams) BindRequest(r *http.Request, route *middleware.MatchedRoute) error {
	var res []error
